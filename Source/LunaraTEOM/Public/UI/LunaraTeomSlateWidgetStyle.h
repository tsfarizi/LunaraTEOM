...
struct FLunaraTeomSlateStyle : public FSlateWidgetStyle
{
	...
	FLinearColor BaseGold = FLinearColor(0.658f, 0.478f, 0.176f);

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Lunara|Colors")
	FLinearColor DeepBlue = FLinearColor(0.110f, 0.184f, 0.360f);

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Lunara|Colors")
	FLinearColor LightBlue = FLinearColor(0.306f, 0.772f, 0.945f);

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Lunara|Colors")
	FLinearColor DarkNavy = FLinearColor(0.086f, 0.133f, 0.262f);

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Lunara|Colors")
	FLinearColor HighlightGold = FLinearColor(0.851f, 0.650f, 0.302f);

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Lunara|Colors")
	FLinearColor MoonGold = FLinearColor(0.721f, 0.537f, 0.227f);
